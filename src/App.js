...
import ImagesList from './component/ImageList'
...
class App extends Component {
  ...
  getFilteredData = () => {
    ...
    const filteredProjectList = imagesList.filter(
      eachImageList => eachImageList.category === activeTab,
    )
    return filteredProjectList
  }

  render() {
    const {activeTab, score, imgUrl, time, isTrue} = this.state
    const filteredImageList = this.getFilteredData()
    return (
        ...
        <div className="match-game-container">
              ...
              <ul className="button-container">
                {tabsList.map(eachTabItem => (
                  <TabItem
                    ...
                    isActive={activeTab === eachTabItem.tabId}
                  />
                ))}
              </ul>
          ...
          {isTrue && (
            <div className="gameOver-container">
              <div className="gameOver-inner-container">
                <img
                  src="https://assets.ccbp.in/frontend/react-js/match-game-trophy.png"
                  className="trophy-image"
                  alt="trophy"
                />
                <p className="gameOver-scoreName">Your Score</p>
